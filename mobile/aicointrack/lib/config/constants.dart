...
class AppConstants {
  ...
  // API Endpoints
  static const String FIREBASE_REGISTER_ENDPOINT =
      '/api/v1/auth/firebase/register';
  ...
  static const String WALLETCONNECT_PROJECT_ID =
      'fec5e6d06b78f02fa5ed0d0cd883b8e5';
  ...
  static const String APP_DESCRIPTION =
      'AI-powered crypto expense tracker on Base';
  ...
  static const int AUTH_TOKEN_REFRESH_INTERVAL =
      3300; // 55 minutes (tokens valid for 60)
